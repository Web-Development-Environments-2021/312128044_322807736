...
function Draw() {
	...
	for (var i = 0; i < 10; i++) {
		for (var j = 0; j < 10; j++) {
			...
			if (board[i][j] == 2) {
				context.beginPath();
				context.arc(center.x, center.y, 23, 0.15 * Math.PI, 1.85 * Math.PI); // half circle
				...
				// context.fillStyle = "rgba(0, 0, 200)"; //color
				// context.clearRect(center.x - 25, center.y - 25, 50, 50);
				context.fill();
			}
		}
	}
